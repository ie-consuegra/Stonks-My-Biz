...
cat ./client/js/languages.js ./client/js/utils.js ./client/js/SmartTable.js ./client/js/settings.js ./client/js/globals.js ./client/js/switchView.js ./client/js/output.js ./client/js/serverCalls.js ./client/js/input.js ./client/js/computations.js ./client/js/onload.js ./client/js/datePickerSetup.js > ./client/bundle.js
